...
@Configuration
@EnableMongoRepositories("com.shashi.firstproject.jhipster.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.shashi.firstproject.jhipster.config.dbmigrations");
